...
when #config(GTK_STATIC, false) {
    foreign import gtk_runic "../lib/linux/x86_64/libgtk.a"
} else {
...
when #config(GTK_STATIC, false) {
    foreign import gtk_runic "../lib/linux/aarch64/libgtk.a"
} else {
    foreign import gtk_runic "system:gtk-4"
}
...
foreign import gtk_runic "../lib/windows/x86_64/gtk-4.lib"
