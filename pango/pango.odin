...
LAYOUT_DESERIALIZE_ERROR :: layout_deserialize_error_quark 
...
GravityHint :: enum u32 {GRAVITY_HINT_NATURAL = 0, GRAVITY_HINT_STRONG = 1, GRAVITY_HINT_LINE = 2, }
_PangoMatrix :: struct {
    xx: f64,
    xy: f64,
    yx: f64,
...
Style :: enum u32 {STYLE_NORMAL = 0, STYLE_OBLIQUE = 1, STYLE_ITALIC = 2, }
Variant :: enum u32 {VARIANT_NORMAL = 0, VARIANT_SMALL_CAPS = 1, VARIANT_ALL_SMALL_CAPS = 2, VARIANT_PETITE_CAPS = 3, VARIANT_ALL_PETITE_CAPS = 4, VARIANT_UNICASE = 5, VARIANT_TITLE_CAPS = 6, }
Weight :: enum u32 {WEIGHT_THIN = 100, WEIGHT_ULTRALIGHT = 200, WEIGHT_LIGHT = 300, WEIGHT_SEMILIGHT = 350, WEIGHT_BOOK = 380, WEIGHT_NORMAL = 400, WEIGHT_MEDIUM = 500, WEIGHT_SEMIBOLD = 600, WEIGHT_BOLD = 700, WEIGHT_ULTRABOLD = 800, WEIGHT_HEAVY = 900, WEIGHT_ULTRAHEAVY = 1000, }
Stretch :: enum u32 {STRETCH_ULTRA_CONDENSED = 0, STRETCH_EXTRA_CONDENSED = 1, STRETCH_CONDENSED = 2, STRETCH_SEMI_CONDENSED = 3, STRETCH_NORMAL = 4, STRETCH_SEMI_EXPANDED = 5, STRETCH_EXPANDED = 6, STRETCH_EXTRA_EXPANDED = 7, STRETCH_ULTRA_EXPANDED = 8, }
FontMask :: enum u32 {FONT_MASK_FAMILY = 1, FONT_MASK_STYLE = 2, FONT_MASK_VARIANT = 4, FONT_MASK_WEIGHT = 8, FONT_MASK_STRETCH = 16, FONT_MASK_SIZE = 32, FONT_MASK_GRAVITY = 64, FONT_MASK_VARIATIONS = 128, }
...
Underline :: enum u32 {UNDERLINE_NONE = 0, UNDERLINE_SINGLE = 1, UNDERLINE_DOUBLE = 2, UNDERLINE_LOW = 3, UNDERLINE_ERROR = 4, UNDERLINE_SINGLE_LINE = 5, UNDERLINE_DOUBLE_LINE = 6, UNDERLINE_ERROR_LINE = 7, }
Overline :: enum u32 {OVERLINE_NONE = 0, OVERLINE_SINGLE = 1, }
ShowFlags :: enum u32 {SHOW_NONE = 0, SHOW_SPACES = 1, SHOW_LINE_BREAKS = 2, SHOW_IGNORABLES = 4, }
TextTransform :: enum u32 {TEXT_TRANSFORM_NONE = 0, TEXT_TRANSFORM_LOWERCASE = 1, TEXT_TRANSFORM_UPPERCASE = 2, TEXT_TRANSFORM_CAPITALIZE = 3, }
BaselineShift :: enum u32 {BASELINE_SHIFT_NONE = 0, BASELINE_SHIFT_SUPERSCRIPT = 1, BASELINE_SHIFT_SUBSCRIPT = 2, }
FontScale :: enum u32 {FONT_SCALE_NONE = 0, FONT_SCALE_SUPERSCRIPT = 1, FONT_SCALE_SUBSCRIPT = 2, FONT_SCALE_SMALL_CAPS = 3, }
...
ShapeFlags :: enum u32 {SHAPE_NONE = 0, SHAPE_ROUND_POSITIONS = 1, }
...
RenderPart :: enum u32 {RENDER_PART_FOREGROUND = 0, RENDER_PART_BACKGROUND = 1, RENDER_PART_UNDERLINE = 2, RENDER_PART_STRIKETHROUGH = 3, RENDER_PART_OVERLINE = 4, }
