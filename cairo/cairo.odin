...
text_cluster_flags_t :: enum u32 {_CAIRO_TEXT_CLUSTER_FLAG_BACKWARD = 1 }
...
path_data_type_t :: enum u32 {_CAIRO_PATH_MOVE_TO = 0, _CAIRO_PATH_LINE_TO = 1, _CAIRO_PATH_CURVE_TO = 2, _CAIRO_PATH_CLOSE_PATH = 3 }
